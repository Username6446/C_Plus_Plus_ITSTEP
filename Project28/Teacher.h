...
private:
	...
	friend inline double Avg(const Pupil& pupil);

};

inline Pupil::Pupil(const string& name, const size_t& math, const size_t& english) :name{name}, math{math}, english{english}
{
}
